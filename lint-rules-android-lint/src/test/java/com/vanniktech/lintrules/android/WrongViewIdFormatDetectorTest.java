...
public class WrongViewIdFormatDetectorTest extends LintDetectorTest {
  ...
  public void testIdIgnored() throws Exception {
    @Language("XML") final String source = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
        + "<TextView xmlns:android=\"http://schemas.android.com/apk/res/android\" xmlns:tools=\"http://schemas.android.com/tools\" tools:ignore=\"WrongViewIdFormat\" android:id=\"@+id/CamelCaseIgnored\"/>\n";
